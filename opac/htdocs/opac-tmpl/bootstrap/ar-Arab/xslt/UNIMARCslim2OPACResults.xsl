...
<xsl:template match="marc:record">
 ...
 <xsl:with-param name="label">ترجمة لـ</xsl:with-param>
 <xsl:with-param name="spanclass">العنوان_الأصلي</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_title">
 <xsl:with-param name="tag">461</xsl:with-param>
 <xsl:with-param name="label">ضبط المستوى</xsl:with-param>
 <xsl:with-param name="spanclass">set_level</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_title">
 <xsl:with-param name="tag">464</xsl:with-param>
 <xsl:with-param name="label">مستوى تحليلي- جزئي</xsl:with-param>
 ...
 <span class="LabelCallNumber">رقم الاستدعاء: </span>
 ...
 <span>
 <xsl:attribute name="class">
 ملخص المادة <xsl:value-of select="translate(items:substatus,' ','_')"/>
 </xsl:attribute>
