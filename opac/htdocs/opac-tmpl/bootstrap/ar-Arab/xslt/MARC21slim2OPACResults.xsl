...
-->
 ...
 متاح عبر الإنترنت <img alt="من بُعد" class="format" src="/opac-tmpl/lib/famfamfam/drive_web.png" />
 </xsl:if>
 ...
 <img alt="لوحة" class="format" src="/opac-tmpl/lib/famfamfam/paintbrush.png" />
 </xsl:if>
...
-->
 ...
 <span class="byAuthor">بواسطة</span><xsl:text> </xsl:text>
...
<xsl:if test="$DisplayOPACiconsXSLT!='0'">
 ...
 <xsl:choose>
 <xsl:when test="$leader19='a'"><img alt="ضبط" class="materialtype mt_icon_ST" src="/opac-tmpl/lib/famfamfam/ST.png" /> ضبط</xsl:when>
 <xsl:when test="$leader6='a'">
 <xsl:choose>
 <xsl:when test="$leader7='c' or $leader7='d' or $leader7='m'"><img alt="نص" class="materialtype mt_icon_BK" src="/opac-tmpl/lib/famfamfam/BK.png" /> نص</xsl:when>
 <xsl:when test="$leader7='i' or $leader7='s'"><img alt="مصدر مستمر" class="materialtype mt_icon_SE" src="/opac-tmpl/lib/famfamfam/SE.png" /> مصدر مستمر</xsl:when>
 <xsl:when test="$leader7='a' or $leader7='b'"><img alt="مقالة" class="materialtype mt_icon_AR" src="/opac-tmpl/lib/famfamfam/AR.png" /> مقالة</xsl:when>
 </xsl:choose>
 </xsl:when>
 <xsl:when test="$leader6='t'"><img alt="نص" class="materialtype mt_icon_BK" src="/opac-tmpl/lib/famfamfam/BK.png" /> نص</xsl:when>
 <xsl:when test="$leader6='o'"><img alt="عدة" class="materialtype mt_icon_MM" src="/opac-tmpl/lib/famfamfam/MM.png" /> عدة</xsl:when>
 <xsl:when test="$leader6='p'"><img alt="مواد مختلطة" class="materialtype mt_icon_MM" src="/opac-tmpl/lib/famfamfam/MM.png" />مواد مختلطة</xsl:when>
 <xsl:when test="$leader6='m'"><img alt="ملف الحاسوب" class="materialtype mt_icon_CF" src="/opac-tmpl/lib/famfamfam/CF.png" /> ملف الحاسوب</xsl:when>
 <xsl:when test="$leader6='e' or $leader6='f'"><img alt="تخطيط" class="materialtype mt_icon_MP" src="/opac-tmpl/lib/famfamfam/MP.png" /> تخطيط</xsl:when>
 <xsl:when test="$leader6='g'"><img alt="فيلم" class="materialtype mt_icon_VM" src="/opac-tmpl/lib/famfamfam/VM.png" /> فيلم</xsl:when>
 <xsl:when test="$leader6='k'"><img alt="صورة" class="materialtype mt_icon_GR" src="/opac-tmpl/lib/famfamfam/GR.png" /> صورة</xsl:when>
 <xsl:when test="$leader6='r'"><img alt="كائن" class="materialtype mt_icon_OB" src="/opac-tmpl/lib/famfamfam/OB.png" /> كائن</xsl:when>
 <xsl:when test="$leader6='c' or $leader6='d'"><img alt="الهدف" class="materialtype mt_icon_PR" src="/opac-tmpl/lib/famfamfam/PR.png" /> الهدف</xsl:when>
 <xsl:when test="$leader6='i'"><img alt="الصوت" class="materialtype mt_icon_MU" src="/opac-tmpl/lib/famfamfam/MU.png" /> الصوت</xsl:when>
 <xsl:when test="$leader6='j'"><img alt="موسيقى" class="materialtype mt_icon_PR" src="/opac-tmpl/lib/famfamfam/PR.png" /> موسيقى</xsl:when>
 </xsl:choose>
 </span>
 </xsl:if>
 ...
 ببليوغرافيا <img alt="ببليوغرافيا" class="natureofcontents" src="/opac-tmpl/lib/famfamfam/text_list_bullets.png" />
 </xsl:when>
...
<xsl:text> </xsl:text> <!-- added blank space to fix font display problem, see Bug 3671 -->
 ...
 <div class="results_summary publisher"><span class="label">تفاصيل النشر: </span>
 ...
 <status english="Checked out">معارة</status>
 <status english="Withdrawn">مسحوبة</status>
 <status english="Lost">ضائعة</status>
 <status english="Damaged">تالفة</status>
 <status english="Pending hold">حجز في الانتظار</status>
 <status english="In transit">في النقل</status>
 <status english="Hold waiting">في الحجز</status>
 <status english="Recall waiting">في انتظار الاستدعاء</status>
 <status english="Not for loan">لا تعار</status>
 </xsl:variable>
 ...
 <xsl:otherwise><span class="noitems">لا توجد مواد متاحة.</span> </xsl:otherwise>
 </xsl:choose>
 </xsl:when>
 ...
 <span class="AvailabilityLabel"><strong><xsl:text>المواد المتاحة للإعارة: </xsl:text></strong></span>
 ...
 <span class="AvailabilityLabel"><strong><xsl:text>المواد المتاحة للمرجعية: </xsl:text></strong></span>
 ...
 <span class="AvailabilityLabel"><strong><xsl:text>غير متاح: </xsl:text></strong></span>
 ...
 <xsl:if test="$OPACItemLocation='callnum'">رقم الاستدعاء: </xsl:if>
 <xsl:if test="$OPACItemLocation='ccode'">المجموعة، رقم الاستدعاء: </xsl:if>
 <xsl:if test="$OPACItemLocation='location'">الموقع، رقم الاستدعاء: </xsl:if>
 </span>
