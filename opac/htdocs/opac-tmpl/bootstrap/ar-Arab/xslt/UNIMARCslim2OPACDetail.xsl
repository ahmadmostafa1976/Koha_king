...
<xsl:template match="marc:record">
 ...
 <xsl:with-param name="label">عنوان موحد</xsl:with-param>
 <xsl:with-param name="spanclass">uniform_title</xsl:with-param>
 </xsl:call-template>

 <xsl:call-template name="tag_title">
 <xsl:with-param name="tag">503</xsl:with-param>
 <xsl:with-param name="label">الرؤوس الموحدة التقليدية</xsl:with-param>
 ...
 <xsl:with-param name="label">بيان الطبعة</xsl:with-param>
 <xsl:with-param name="spanclass">الطبعة</xsl:with-param>
 </xsl:call-template>
