...
<xsl:stylesheet version="1.0"
 ...
 <xsl:variable name="SubjectModifier"><xsl:if test="marc:sysprefs/marc:syspref[@name='TraceCompleteSubfields']='1'">،حقل فرعي-كامل</xsl:if></xsl:variable>
 ...
 <xsl:when test="$leader7='a' or $leader7='b'">العربية</xsl:when>
 </xsl:choose>
 </xsl:when>
 ...
 <xsl:choose>
 <xsl:when test="$leader19='a'">ضبط</xsl:when>
 <xsl:when test="$leader6='a'">
 <xsl:choose>
 <xsl:when test="$leader7='c' or $leader7='d' or $leader7='m'">نص</xsl:when>
 <xsl:when test="$leader7='i' or $leader7='s'">
 <xsl:choose>
 <xsl:when test="substring($controlField008,22,1)!='m'">مصدر مستمر</xsl:when>
 <xsl:otherwise>السلاسل</xsl:otherwise>
 </xsl:choose>
 </xsl:when>
 <xsl:when test="$leader7='a' or $leader7='b'">مقالة</xsl:when>
 </xsl:choose>
 </xsl:when>
 <xsl:when test="$leader6='t'">نص</xsl:when>
 <xsl:when test="$leader6='o'">عدة</xsl:when>
 <xsl:when test="$leader6='p'">مواد مختلطة</xsl:when>
 <xsl:when test="$leader6='m'">ملف الحاسوب</xsl:when>
 <xsl:when test="$leader6='e' or $leader6='f'">تخطيط</xsl:when>
 <xsl:when test="$leader6='g'">فيلم</xsl:when>
 <xsl:when test="$leader6='k'">صورة</xsl:when>
 <xsl:when test="$leader6='r'">كائن</xsl:when>
 <xsl:when test="$leader6='j'">موسيقى</xsl:when>
 <xsl:when test="$leader6='i'">الصوت</xsl:when>
 <xsl:when test="$leader6='c' or $leader6='d'">الهدف</xsl:when>
 </xsl:choose>
 </xsl:variable>
 ...
 <xsl:choose>
 <xsl:when test="$materialTypeLabel='Book'">كتاب</xsl:when>
 <xsl:when test="$materialTypeLabel='Map'">تخطيط</xsl:when>
 ...
 <xsl:attribute name="typeof"><xsl:value-of select='$schemaOrgType' /> منتج</xsl:attribute>
 <xsl:attribute name="resource">#تسجيلة</xsl:attribute>
 ...
 <span class="results_summary type"><span class="label">نوع المادة : </span>
 ...
 <xsl:with-param name="class">ملخص النتائج السلاسل</xsl:with-param>
 ...
 <xsl:when test="$leader7='c'">مجموعة_تحليلية</xsl:when>
 <xsl:when test="$leader7='d'">وحدة فرعية_تحليلية</xsl:when>
 <xsl:when test="$leader7='i'">analytic_ires</xsl:when>
 <xsl:when test="$leader7='m'">أفرودة_تحليلية</xsl:when>
 <xsl:when test="$leader7='s'">دورية_تحليلية</xsl:when>
 <xsl:otherwise>تحليلية_غير معرفة</xsl:otherwise>
 </xsl:choose>
 </xsl:variable>
 ...
 <xsl:attribute name="class">تحليلات ملخص_النتائج <xsl:value-of select="$leader7_class"/></xsl:attribute>
 <span class="label">مداخل تحليلية: </span>
 <a>
 <xsl:choose>
 ...
 <xsl:text>أظهر التحليلات</xsl:text>
 </a>
 </xsl:element>
 </xsl:if>
 ...
 <span class="results_summary volumes"><span class="label">المجلدات: </span>
 <a>
 <xsl:choose>
 <xsl:when test="$UseControlNumber = '1' and marc:controlfield[@tag=001]">
 ...
 <xsl:text>عرض المجلدات</xsl:text>
 </a>
 </span>
 </xsl:if>
 ...
 <span class="results_summary set"><span class="label">ضبط: </span>
 ...
 <xsl:with-param name="class">إضافة ملخص النتائج</xsl:with-param>
 <xsl:with-param name="label">الطبعة: </xsl:with-param>
 </xsl:call-template>
 </xsl:if>

 <xsl:if test="marc:datafield[@tag=250]">
 <span class="results_summary edition"><span class="label">الطبعة: </span>
 ...
 <xsl:with-param name="class">وصف ملخص النتائج</xsl:with-param>
 <xsl:with-param name="label">الوصف: </xsl:with-param>
 </xsl:call-template>
 </xsl:if>
 ...
 <span class="label">نوع الوسائط: </span>
 <ul class="resource_list">
 ...
 <span class="label">نوع الناقل: </span>
 <ul class="resource_list">
 ...
 <span class="results_summary isbn"><span class="label">تدمك: </span>
 <ul class="resource_list">
 ...
 <span class="results_summary issn"><span class="label">تدمد: </span>
 <ul class="resource_list">
 ...
 <span class="label">معلومات براءة الاختراع: </span>
 ...
 <xsl:choose>
 <xsl:when test="@ind2=0"> [جزء من العنوان]</xsl:when>
 <xsl:when test="@ind2=1"> [عنوان موازي]</xsl:when>
 <xsl:when test="@ind2=2"> [عنوان مميز]</xsl:when>
 <xsl:when test="@ind2=3"> [عنوان آخر]</xsl:when>
 <xsl:when test="@ind2=4"> [عنوان الغلاف]</xsl:when>
 <xsl:when test="@ind2=5"> [عنوان مضاف عنوان الصفحة]</xsl:when>
 <xsl:when test="@ind2=6"> [عنوان التسمية التوضيحية]</xsl:when>
 <xsl:when test="@ind2=7"> [عنوان التشغيل]</xsl:when>
 <xsl:when test="@ind2=8"> [عنوان الكعب]</xsl:when>
 </xsl:choose>
 </xsl:if>
 </span>
 </li>
 ...
 <span class="results_summary translated_title"><span class="label">العنوان المترجم: </span>
 ...
 <xsl:with-param name="class">ملخص النتائج عنوان موحد</xsl:with-param>
 <xsl:with-param name="label">العناوين الموحدة: </xsl:with-param>
 </xsl:call-template>
 </span>
 </xsl:if>
 ...
 <span class="label">العناوين الموحدة: </span>
 <ul class="resource_list">
 ...
 <span class="label">أعمال ذات صلة: </span>
 <ul class="resource_list">
 ...
 <span class="label">الأعمال المتضمنة: </span>
 <ul class="resource_list">
 ...
 <a>
 <xsl:attribute name="class">موضوع</xsl:attribute>
 <xsl:choose>
 ...
 <xsl:with-param name="delimeter"> و </xsl:with-param>
 <xsl:with-param name="prefix">(الأحد<xsl:value-of select="$SubjectModifier"/>:<xsl:value-of select="$TracingQuotesLeft"/></xsl:with-param>
 ...
 <xsl:element name="i">
 <xsl:attribute name="class">fa fa-بحث</xsl:attribute>
 </xsl:element>
 </a>
 </xsl:if>
 </li>
 ...
 <span class="label">النوع/الشكل: </span>
 <ul class="resource_list">
 ...
 <xsl:with-param name="delimeter"> و </xsl:with-param>
 <xsl:with-param name="prefix">(الفهرس-المصطلح-النوع<xsl:value-of select="$SubjectModifier"/>:<xsl:value-of select="$TracingQuotesLeft"/></xsl:with-param>
 <xsl:with-param name="suffix"><xsl:value-of select="$TracingQuotesRight"/>)</xsl:with-param>
 <xsl:with-param name="urlencode">1</xsl:with-param>
 </xsl:call-template>
 </xsl:attribute>
...
<!-- MARC21 776 Additional Physical Form Entry -->
 ...
 <span class="label">تنسيقات مادية إضافية: </span>
 ...
 <xsl:otherwise>
 <xsl:text>لا توجد عناوين</xsl:text>
 </xsl:otherwise>
 </xsl:choose>
 </xsl:variable>
...
<!-- DDC classification -->
 ...
 <span class="label">تصنيف ديوي العشري: </span>
 <ul class="resource_list">
...
<!-- LOC classification -->
 ...
 <span class="label">تصنيف مكتبة الكونجرس: </span>
 <ul class="resource_list">
...
<!-- NLM classification -->
 ...
 <span class="label">تصنيف المكتبة الوطنية للطب: </span>
 <ul class="resource_list">
...
<!-- Other classification -->
 ...
 <span class="label">تصنيفات أخرى: </span>
 <ul class="resource_list">
 ...
 <xsl:attribute name="target">_فارغ</xsl:attribute>
 </xsl:if>
 <xsl:choose>
 <xsl:when test="($Show856uAsImage='Details' or $Show856uAsImage='Both') and (substring($SubqText,1,6)='image/' or $SubqText='img' or $SubqText='bmp' or $SubqText='cod' or $SubqText='gif' or $SubqText='ief' or $SubqText='jpe' or $SubqText='jpeg' or $SubqText='jpg' or $SubqText='jfif' or $SubqText='png' or $SubqText='svg' or $SubqText='tif' or $SubqText='tiff' or $SubqText='ras' or $SubqText='cmx' or $SubqText='ico' or $SubqText='pnm' or $SubqText='pbm' or $SubqText='pgm' or $SubqText='ppm' or $SubqText='rgb' or $SubqText='xbm' or $SubqText='xpm' or $SubqText='xwd')">
 <xsl:element name="img"><xsl:attribute name="src"><xsl:value-of select="marc:subfield[@code='u']"/></xsl:attribute><xsl:attribute name="alt"><xsl:value-of select="marc:subfield[@code='y']"/></xsl:attribute><xsl:attribute name="style">الارتفاع: 100 بيكسل</xsl:attribute></xsl:element><xsl:text></xsl:text>
 </xsl:when>
 ...
 <span class="results_summary other_relationship_entry"><span class="label">أعمال أخرى ذات صلة: </span>
 ...
 <span class="label">الأشكال المادية الإضافية المتاحة:</span>
 <ul class="resource_list">
 ...
 <span class="label">محتويات غير مكتملة:</span>
 </xsl:when>
 <xsl:when test="@ind1=2">
 <span class="label">قائمة محتويات جزئية:</span>
 </xsl:when>
 <xsl:otherwise>
 <span class="label">المحتويات:</span>
 </xsl:otherwise>
 </xsl:choose>
 </xsl:if>
 ...
 <span class="label">ملاحظة الإجراء: </span>
 <ul class="resource_list">
 ...
 <span class="label">اعتمادات الإنتاج: </span>
 <ul class="resource_list">
 ...
 <span class="label">
 <xsl:if test="@ind1=1"><xsl:text>طاقم: </xsl:text></xsl:if>
 </span>
 <xsl:call-template name="subfieldSelect">
 <xsl:with-param name="codes">a</xsl:with-param>
 </xsl:call-template>
 ...
 <span class="label">
 <xsl:choose>
 <xsl:when test="@ind1=0"><xsl:text>الموضوع: </xsl:text></xsl:when>
 <xsl:when test="@ind1=1"><xsl:text>مراجعة: </xsl:text></xsl:when>
 <xsl:when test="@ind1=2"><xsl:text>النطاق والمحتوى: </xsl:text></xsl:when>
 <xsl:when test="@ind1=3"><xsl:text>مستخلص: </xsl:text></xsl:when>
 <xsl:when test="@ind1=4"><xsl:text>نصيحة المحتوى: </xsl:text></xsl:when>
 <xsl:otherwise><xsl:text>ملخص: </xsl:text></xsl:otherwise>
 </xsl:choose>
 </span>
 <xsl:call-template name="subfieldSelect">
 <xsl:with-param name="codes">abc</xsl:with-param>
 ...
 <span class="results_summary holdings_note basic_bibliographic_unit"><span class="label">المقتنيات: </span>
 <xsl:for-each select="marc:datafield[@tag=866]">
 <span class="holdings_note_data">
 <xsl:call-template name="subfieldSelect">
 <xsl:with-param name="codes">تصاعدي</xsl:with-param>
 </xsl:call-template>
 <xsl:choose><xsl:when test="position()=last()"><xsl:text></xsl:text></xsl:when><xsl:otherwise><xsl:text>; </xsl:text></xsl:otherwise></xsl:choose>
 </span>
 </xsl:for-each>
 ...
 <span class="results_summary holdings_note supplementary_material"><span class="label">ملحقات: </span>
 ...
 <span class="results_summary holdings_note indexes"><span class="label">الفهارس: </span>
 ...
 <span class="results_summary other_editions"><span class="label">طبعات أخرى: </span>
 ...
 <xsl:choose>
 <xsl:when test="@ind2=0">
 <span class="label">متابعة:</span>
 </xsl:when>
 <xsl:when test="@ind2=1">
 <span class="label">متابعة جزئية:</span>
 </xsl:when>
 <xsl:when test="@ind2=2">
 <span class="label">تحل محل:</span>
 </xsl:when>
 <xsl:when test="@ind2=3">
 <span class="label">يحل محل جزئياً:</span>
 </xsl:when>
 <xsl:when test="@ind2=4">
 <span class="label">التي شكلها اتحاد: ... و: ...</span>
 </xsl:when>
 <xsl:when test="@ind2=5">
 <span class="label">منشور:</span>
 </xsl:when>
 <xsl:when test="@ind2=6">
 <span class="label">منشور جزئيا:</span>
 </xsl:when>
 <xsl:when test="@ind2=7">
 <span class="label">منفضل عن:</span>
 </xsl:when>
 </xsl:choose>
 <xsl:text> </xsl:text>
 ...
 <xsl:choose>
 <xsl:when test="@ind2=0">
 <span class="label">المتابعة بواسطة:</span>
 </xsl:when>
 <xsl:when test="@ind2=1">
 <span class="label">متابعة جزئية بواسطة:</span>
 </xsl:when>
 <xsl:when test="@ind2=2">
 <span class="label">استبدلت بواسطة:</span>
 </xsl:when>
 <xsl:when test="@ind2=3">
 <span class="label">استبدلت في الجزء بواسطة:</span>
 </xsl:when>
 <xsl:when test="@ind2=4">
 <span class="label">نشر بواسطة:</span>
 </xsl:when>
 <xsl:when test="@ind2=5">
 <span class="label">منشور جزئيا بواسطة:</span>
 </xsl:when>
 <xsl:when test="@ind2=6">
 <span class="label">تقسيم إلى.. و...:</span>
 </xsl:when>
 <xsl:when test="@ind2=7">
 <span class="label">دمجت مع ...للنموذج ...</span>
 </xsl:when>
 <xsl:when test="@ind2=8">
 <span class="label">تغيير إلى:</span>
 </xsl:when>
 </xsl:choose>
 <xsl:text> </xsl:text>
 ...
 <xsl:text> تشغيل هذه العينة</xsl:text>
 </button>
 </div>
 </xsl:if>
 </xsl:if>
 ...
 <!-- #13383 -->
 <xsl:when test="@tag&lt;700"><span class="byAuthor">بواسطة: </span></xsl:when>
 <!--#13382 Changed Additional author to contributor -->
 <xsl:otherwise>المساهم: </xsl:otherwise>
 </xsl:choose>
 </xsl:for-each>
 <ul class="resource_list">
 <xsl:for-each select="$authorfield">
 ...
 <xsl:attribute name="class">المساهمون</xsl:attribute>
 ...
 <xsl:otherwise><xsl:attribute name="property">المؤلف</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 </xsl:when>
 <xsl:otherwise><xsl:attribute name="property">مساهم</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 <xsl:choose>
 <xsl:when test="substring(@tag, 2, 1)='0'">
 <xsl:choose>
 <xsl:when test="$materialTypeLabel='Music'"><xsl:attribute name="typeof">مجموعة موسيقية</xsl:attribute></xsl:when>
 <xsl:otherwise><xsl:attribute name="typeof">شخص</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 </xsl:when>
 <xsl:otherwise><xsl:attribute name="typeof">المؤسسة</xsl:attribute></xsl:otherwise>
 </xsl:choose>
 <span property="name">
 <xsl:choose>
