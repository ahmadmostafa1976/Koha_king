...
<xsl:stylesheet version="1.0" xmlns:xlink="http://www.w3.org/TR/xlink" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns="http://www.loc.gov/mods/" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="marc">
 ...
 <name>
 <xsl:if test="@ind1=1">
 <xsl:attribute name="type">شخصي</xsl:attribute>
 </xsl:if>
 <namePart>
 ...
 <form><controlled>برايل</controlled></form>
 </xsl:when>
 <xsl:when test="$leader6 = 'm' or ($check008-23 and $controlField008-23='s') or ($check008-29 and $controlField008-29='s')">
 <form><controlled>الكتروني</controlled></form>
 </xsl:when>
 <xsl:when test="($check008-23 and $controlField008-23='b') or ($check008-29 and $controlField008-29='b')">
 <form><controlled>ميكروفيش</controlled></form>
 </xsl:when>
 <xsl:when test="($check008-23 and $controlField008-23='a') or ($check008-29 and $controlField008-29='a')">
 <form><controlled>ميكروفيلم</controlled></form>
 </xsl:when>
 </xsl:choose>
 ...
 <targetAudience>مراهق</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='e'">
 <targetAudience>بالغ</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='g'">
 <targetAudience>عام</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='b' or $controlField008-22='c' or $controlField008-22='j'">
 <targetAudience>حدث</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='a'">
 <targetAudience>ما قبل المدرسة</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='f'">
 <targetAudience>متخصص</targetAudience>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <xsl:choose>
 <xsl:when test="@ind1=0">رقم العدد</xsl:when>
 <xsl:when test="@ind1=1">رقم المصفوفة</xsl:when>
 <xsl:when test="@ind1=2">طبق موسيقى</xsl:when>
 <xsl:when test="@ind1=3">ناشر موسيقى</xsl:when>
 <xsl:when test="@ind1=4">معرّف تسجيل الفيديو</xsl:when>
 </xsl:choose>
 </xsl:attribute>
 <xsl:call-template name="subfieldSelect">
 <xsl:with-param name="codes">ab</xsl:with-param>
...
-->
 ...
 <xsl:attribute name="type">
 <xsl:choose>
 <xsl:when test="@ind2=2">المكونة</xsl:when>
 <xsl:otherwise>مرتبط</xsl:otherwise>
 </xsl:choose>
 </xsl:attribute>
 </xsl:template>
 ...
 <xsl:when test="@ind2=2">شبكية</xsl:when>
