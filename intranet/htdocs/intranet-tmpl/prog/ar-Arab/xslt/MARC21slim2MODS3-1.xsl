...
-->
 ...
 <role>
 <roleTerm authority="marcrelator" type="text">منشئ</roleTerm>
 </role>
 ...
 <name>
 <xsl:if test="@ind1=1">
 <xsl:attribute name="type"><xsl:text>شخصي</xsl:text></xsl:attribute>
 </xsl:if>
 <namePart>
 ...
 <xsl:when test="$leader6='i'">تسجيل صوت غير موسيقي</xsl:when>
 <xsl:when test="$leader6='j'">تسجيل صوت موسيقي</xsl:when>
 ...
 <genre authority="marc">كرة أرضية</genre>
 </xsl:if>
 <xsl:if test="marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='r']">
 <genre authority="marc">صورة إستشعار عن بعد</genre>
 </xsl:if>
 ...
 <genre authority="marc">قاعدة البيانات</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='l'">
 <genre authority="marc">سائبة</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='m'">
 <genre authority="marc">سلاسل</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='n'">
 <genre authority="marc">جريدة</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='p'">
 <genre authority="marc">دورية</genre>
 </xsl:when>
 <xsl:when test="$controlField008-21='w'">
 <genre authority="marc">موقع ويب</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <genre authority="marc">نبذة أو ملخص</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'b')">
 <genre authority="marc">ببليوغرافيا</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'c')">
 <genre authority="marc">الفهرس</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'d')">
 <genre authority="marc">قاموس</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'e')">
 <genre authority="marc">موسوعة</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'f')">
 <genre authority="marc">دليل</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'g')">
 <genre authority="marc">مقال قانوني</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'i')">
 <genre authority="marc">فهرس</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'k')">
 <genre authority="marc">ديسكوغرافيا</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'l')">
 <genre authority="marc">التشريع</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'m')">
 <genre authority="marc">اطروحات</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'n')">
 <genre authority="marc">استطلاع للأدب</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'o')">
 <genre authority="marc">مراجعة</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'p')">
 <genre authority="marc">نصوص مبرمجة</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'q')">
 <genre authority="marc">الأعمال الفنية</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'r')">
 <genre authority="marc">دليل</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'s')">
 <genre authority="marc">إحصائيات</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'t')">
 <genre authority="marc">تقرير تقني</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'v')">
 <genre authority="marc">قضايا قانوينة وملاحظات القضية</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'w')">
 <genre authority="marc">تقرير قانوني أو ملخص</genre>
 </xsl:when>
 <xsl:when test="contains($controlField008-24,'z')">
 <genre authority="marc">اتفاقية</genre>
 </xsl:when>
 </xsl:choose>
 <xsl:variable name="controlField008-29" select="substring($controlField008,30,1)"/>
 <xsl:choose>
 <xsl:when test="$controlField008-29='1'">
 <genre authority="marc">مطبوع مؤتمر</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <genre authority="marc">بيانات رقمية</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='e'">
 <genre authority="marc">قاعدة البيانات</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='f'">
 <genre authority="marc">خط</genre>
 </xsl:when>
 <xsl:when test="$controlField008-26='g'">
 <genre authority="marc">لعبة</genre>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 <xsl:if test="$typeOf008='BK'">
 <xsl:if test="substring($controlField008,25,1)='j'">
 <genre authority="marc">براءات الاختراع</genre>
 </xsl:if>
 <xsl:if test="substring($controlField008,31,1)='1'">
 <genre authority="marc">كتاب تذكاري</genre>
 </xsl:if>
 <xsl:variable name="controlField008-34" select="substring($controlField008,35,1)"/>
 <xsl:if test="$controlField008-34='a' or $controlField008-34='b' or $controlField008-34='c' or $controlField008-34='d'">
 <genre authority="marc">السيرة الذاتية</genre>
 </xsl:if>
 <xsl:variable name="controlField008-33" select="substring($controlField008,34,1)"/>
 <xsl:choose>
 <xsl:when test="$controlField008-33='e'">
 <genre authority="marc">مقال</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='d'">
 <genre authority="marc">دراما</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='c'">
 <genre authority="marc">فكاهية</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='l'">
 <genre authority="marc">خيال</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='h'">
 <genre authority="marc">دعابة ، سخرية</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='i'">
 <genre authority="marc">خطاب</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='f'">
 <genre authority="marc">رواية</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='j'">
 <genre authority="marc">قصة قصيرة</genre>
 </xsl:when>
 ...
 <genre authority="marc">قصة شعبية</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'h')">
 <genre authority="marc">تاريخ</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'k')">
 <genre authority="marc">دعابة ، سخرية</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'m')">
 <genre authority="marc">مذكرة</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'p')">
 <genre authority="marc">شعر</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'r')">
 <genre authority="marc">بروفة</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'g')">
 <genre authority="marc">التقرير</genre>
 </xsl:if>
 <xsl:if test="contains($controlField008-30-31,'s')">
 <genre authority="marc">صوت</genre>
 </xsl:if>
 ...
 <genre authority="marc">فن أصلى</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='b'">
 <genre authority="marc">عدة</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='c'">
 <genre authority="marc">استنساخ فني</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='d'">
 <genre authority="marc">الديوراما</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='f'">
 <genre authority="marc">شريط سينمائي</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='g'">
 <genre authority="marc">مقال قانوني</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='i'">
 <genre authority="marc">صور</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='k'">
 <genre authority="marc">جرافيك</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='l'">
 <genre authority="marc">رسم تقني</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='m'">
 <genre authority="marc">صورة متحركة</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='n'">
 <genre authority="marc">الرسم البياني</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='o'">
 <genre authority="marc">بطاقة فلاش</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='p'">
 <genre authority="marc">شريحة مجهر</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='q' or marc:controlfield[@tag=007][substring(text(),1,1)='a'][substring(text(),2,1)='q']">
 <genre authority="marc">وحدة</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='r'">
 <genre authority="marc">حقائق</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='s'">
 <genre authority="marc">شريحة</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='t'">
 <genre authority="marc">شفاف</genre>
 </xsl:when>
 <xsl:when test="$controlField008-33='v'">
 <genre authority="marc">تسجيل فيديو</genre>
 </xsl:when>
 ...
 <place>
 <placeTerm>
 <xsl:attribute name="type">رمز</xsl:attribute>
 <xsl:attribute name="authority">بلد مارك</xsl:attribute>
 ...
 <place>
 <placeTerm>
 <xsl:attribute name="type">نص</xsl:attribute>
 ...
 <issuance>
 <xsl:choose>
 <xsl:when test="$leader7='a' or $leader7='c' or $leader7='d' or $leader7='m'">تخصصية</xsl:when>
 <xsl:when test="$leader7='b' or $leader7='i' or $leader7='s'">استمرار</xsl:when>
 </xsl:choose>
 </issuance>
 </xsl:for-each>
 ...
 <digitalOrigin>إعادة صياغة رقمية</digitalOrigin>
 </xsl:if>
 ...
 <form authority="marcform">برايل</form>
 </xsl:when>
 ...
 <form authority="marcform">طباعة</form>
 </xsl:when>
 <xsl:when test="$leader6 = 'm' or ($check008-23 and $controlField008-23='s') or ($check008-29 and $controlField008-29='s')">
 <form authority="marcform">الكتروني</form>
 </xsl:when>
 <xsl:when test="($check008-23 and $controlField008-23='b') or ($check008-29 and $controlField008-29='b')">
 <form authority="marcform">ميكروفيش</form>
 </xsl:when>
 <xsl:when test="($check008-23 and $controlField008-23='a') or ($check008-29 and $controlField008-29='a')">
 <form authority="marcform">ميكروفيلم</form>
 </xsl:when>
 </xsl:choose>
 <!-- 1/04 fix -->
 ...
 <reformattingQuality>الوصول</reformattingQuality>
 </xsl:when>
 <xsl:when test="substring(text(),14,1)='p'">
 <reformattingQuality>حفظ</reformattingQuality>
 </xsl:when>
 <xsl:when test="substring(text(),14,1)='r'">
 <reformattingQuality>استبدال</reformattingQuality>
 </xsl:when>
 </xsl:choose>
 </xsl:for-each>
 ...
 <targetAudience authority="marctarget">مراهق</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='e'">
 <targetAudience authority="marctarget">بالغ</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='g'">
 <targetAudience authority="marctarget">عام</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='b' or $controlField008-22='c' or $controlField008-22='j'">
 <targetAudience authority="marctarget">حدث</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='a'">
 <targetAudience authority="marctarget">ما قبل المدرسة</targetAudience>
 </xsl:when>
 <xsl:when test="$controlField008-22='f'">
 <targetAudience authority="marctarget">متخصص</targetAudience>
 </xsl:when>
 </xsl:choose>
 </xsl:if>
 ...
 <identifier>
 <xsl:call-template name="isInvalid"/>
 <xsl:attribute name="type"><xsl:choose><xsl:when test="@ind1=0">رقم العدد</xsl:when><xsl:when test="@ind1=1">رقم المصفوفة</xsl:when><xsl:when test="@ind1=2">طبق موسيقى</xsl:when><xsl:when test="@ind1=3">ناشر موسيقى</xsl:when><xsl:when test="@ind1=4">معرّف تسجيل الفيديو</xsl:when></xsl:choose></xsl:attribute>
 <xsl:call-template name="subfieldSelect">
 ...
 <xsl:if test="@ind2=2">
 <xsl:attribute name="type">المكونة</xsl:attribute>
 </xsl:if>
 </xsl:template>
 ...
 <xsl:if test="@ind2!=8">
 <xsl:if test="@ind2!=9">
 <xsl:attribute name="authority"><xsl:choose><xsl:when test="@ind2=0">lcsh</xsl:when><xsl:when test="@ind2=1">lcshac</xsl:when><xsl:when test="@ind2=2">شبكية</xsl:when><!-- 1/04 fix --><xsl:when test="@ind2=3">nal</xsl:when><xsl:when test="@ind2=5">csh</xsl:when><xsl:when test="@ind2=6">rvm</xsl:when><xsl:when test="@ind2=7"><xsl:value-of select="marc:subfield[@code='2']"/></xsl:when></xsl:choose></xsl:attribute>
 </xsl:if>
 </xsl:if>
 </xsl:if>
 </xsl:if>
 ...
 <xsl:attribute name="invalid">نعم</xsl:attribute>
 </xsl:if>
 </xsl:template>
 ...
 <xsl:attribute name="script"><xsl:choose><xsl:when test="$scriptCode='(3'">العربية</xsl:when><xsl:when test="$scriptCode='(B'">اللاتينية</xsl:when><xsl:when test="$scriptCode='$1'">الصينية, اليابانية, الكورية</xsl:when><xsl:when test="$scriptCode='(N'">السيريلية</xsl:when><xsl:when test="$scriptCode='(2'">العبرية</xsl:when><xsl:when test="$scriptCode='(S'">اليونانية</xsl:when></xsl:choose></xsl:attribute>
 </xsl:template>
 ...
 <language>
 <xsl:if test="@code!='a'">
 <xsl:attribute name="objectPart"><xsl:choose><xsl:when test="@code='b'">الملخص أو العنوان الفرعي</xsl:when><xsl:when test="@code='d'">مُغنى أو نص منطوق</xsl:when><xsl:when test="@code='e'">نص كلام الأوبرا</xsl:when><xsl:when test="@code='f'">جدول المحتويات</xsl:when><xsl:when test="@code='g'">المواد المرافقة</xsl:when><xsl:when test="@code='h'">ترجمة</xsl:when></xsl:choose></xsl:attribute>
 </xsl:if>
 <languageTerm authority="iso639-2b" type="code">
