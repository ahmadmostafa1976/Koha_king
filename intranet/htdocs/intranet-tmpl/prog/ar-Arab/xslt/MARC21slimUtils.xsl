 ...
 * Pitfalls:
 ...
 <span class="label">تاريخ حقوق النشر: </span>
 </xsl:when>
 </xsl:choose>
 ...
 <xsl:with-param name="class">ردمك</xsl:with-param>
 <xsl:with-param name="label">تدمك: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="showSingleSubfield">
 <xsl:with-param name="tag">022</xsl:with-param>
 <xsl:with-param name="code">a</xsl:with-param>
 <xsl:with-param name="class">تدمد</xsl:with-param>
 <xsl:with-param name="label">تدمد: </xsl:with-param>
 </xsl:call-template>
 </xsl:template>
 ...
 <xsl:with-param name="langLabel">اللغة: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='b']"/>
 <xsl:with-param name="langLabel">لغة الملخص: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='d']"/>
 <xsl:with-param name="langLabel">اللغة المنطوقة: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='h']"/>
 <xsl:with-param name="langLabel">اللغة الأصلية: </xsl:with-param>
 </xsl:call-template>
 <xsl:call-template name="show-lang-node">
 <xsl:with-param name="langNode" select="marc:subfield[@code='j']"/>
 <xsl:with-param name="langLabel">لغة الترجمة: </xsl:with-param>
 </xsl:call-template>
 </span>
 </xsl:for-each>
 </xsl:if>
 ...
 <span class="results_summary series"><span class="label">السلاسل: </span>
 <!-- 440 -->
