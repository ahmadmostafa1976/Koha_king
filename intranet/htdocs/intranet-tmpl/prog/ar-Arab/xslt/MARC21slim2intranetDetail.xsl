...
<xsl:stylesheet version="1.0"
 ...
 <span class="results_summary other_title"><span class="label">عنوان آخر: </span>
 ...
 <xsl:with-param name="label">العنوان الموحد: </xsl:with-param>
 </xsl:call-template>
 </xsl:if>

 <xsl:if test="marc:datafield[@tag=130]|marc:datafield[@tag=240]|marc:datafield[@tag=730][@ind2!=2]">
 <span class="results_summary uniform_title"><span class="label">العناوين الموحدة: </span>
 ...
 <span class="results_summary related_works"><span class="label">أعمال ذات صلة: </span>
 ...
 <span class="results_summary contained_works"><span class="label">الأعمال المتضمنة: </span>
 ...
 <span class="results_summary subjects"><span class="label">الموضوع: </span>
 ...
 <span class="results_summary genre"><span class="label">النوع/الشكل: </span>
...
<!-- Other classification -->
 ...
 <span class="results_summary online_resources"><span class="label">موارد على الإنترنت: </span>
 ...
 <span class="results_summary supplement"><span class="label">ملحق: </span>
 ...
 <span class="results_summary supplement_parent"><span class="label">ملحق لـ: </span>
 ...
 محجوب في الأوباك </span>
 </xsl:when>
 <xsl:otherwise>
 <xsl:if test="$OPACBaseURL!=''">
 <span class="results_summary opac_view"><span class="label">عرض الأوباك: </span>
 <a><xsl:attribute name="href"><xsl:value-of select="$OPACBaseURL"/>/cgi-bin/koha/opac-detail.pl?biblionumber=<xsl:value-of select="str:encode-uri(marc:datafield[@tag=999]/marc:subfield[@code='c'], true())"/></xsl:attribute><xsl:attribute name="target">_فارغ</xsl:attribute>افتح في نافذة جديدة</a>.
 </span>
 </xsl:if>
 </xsl:otherwise>
 </xsl:choose>
 ...
 <xsl:attribute name="title">عرض تسجيلة الاستناد</xsl:attribute>
 <xsl:attribute name="target">_فارغ</xsl:attribute>
 <xsl:element name="i">
 <xsl:attribute name="class">fa fa-بحث</xsl:attribute>
 <xsl:attribute name="aria-label">عرض تسجيلة الاستناد</xsl:attribute>
 </xsl:element>
 </a>
 </xsl:template>
